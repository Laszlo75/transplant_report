...
theme_swd <-
  function() {
    theme_minimal(base_size = 8, base_family = "Arial") + # default size 8
      theme(
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        axis.line = element_line(size = .2, color = GRAY8), # default .1
        ...
        # This aligns the plot title to the very left edge
